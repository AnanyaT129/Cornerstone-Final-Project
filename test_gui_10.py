...
sys.path.append("/Users/tedye/Documents/Final_Project_Cornerstone")
...
def _quit():
    with open('/Users/tedye/Documents/Final_Project_Cornerstone/output.txt', 'w') as output:
...
list_of_data = btm.open_data_file('/Users/tedye/Documents/Final_Project_Cornerstone/output.txt')
N = len(list_of_data)
samples = range(N)
Fs = 40; # in Hz
Fnyq = Fs / 2
