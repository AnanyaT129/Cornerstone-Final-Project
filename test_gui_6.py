...
def animate(i):
    ...
    line_3.set_ydata(ys_delay)
    return line, line_2, line_3,
...
line_2, = analysis.plot(x, rms, 'g')
line_3, = analysis.plot(x, np.array(ys_delay[0:200]), 'r')
